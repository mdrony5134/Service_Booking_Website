...
const Customer = () => {
  ...
  return (
    <section ref={ref} className="bg-gray-100 relative mt-10">
      <div className="absolute top-6 left-[8%] md:top-14 md:left-[30%]">
        <motion.h1
          initial={{ opacity: 0, x: -100 }}
          animate={isInView ? { opacity: 1, x: 0 } : {}}
          transition={{ duration: 1.5 }}
          className="text-lg md:text-4xl text-center font-bold"
        >
          Real Happy Customers,
          <span className="text-[#41B3A2]"> Real Stories</span>
        </motion.h1>
      </div>
        ...
        <div class="flex items-center pt-16  md:pb-14 md:w-1/2  md:pr-10">
          ...
          >
            <blockquote class="relative border-s-4 ps-4 sm:ps-6 border-[#41B3A2]">
              <p class="text-gray-800 sm:text-xl dark:text-white md:text-4xl">
                <em>
